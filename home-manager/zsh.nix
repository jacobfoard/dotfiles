          ...
          + (
            if pkgs.stdenv.system == "aarch64-darwin" then
              ''
                ...
                fpath=(/opt/homebrew/share/zsh/site-functions ${config.home.profileDirectory}/share/zsh/site-functions ${config.home.profileDirectory}/share/zsh/vendor-completions $fpath)
              ''
            else
              ""
          )
